...
# 2015/09/29
#
# Modified code to prevent exceptions breaking the flow of the script
# Goran Radosevic
# 2016/10/20
#
...
parser.add_argument('imgs', type=str, nargs='+', help="Input images.")
parser.add_argument('imgs2', type=str, nargs='+', help="Input2 images.")
...
for (img1, img2) in list(itertools.product(args.imgs, args.imgs2)):
    try:
